...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="tt" style="padding: 10px">
        ...
        <label style="margin-left: 1%; margin-right: 2%">
            <input style="display: inline; width: 170px" id="excelFile" type="file" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel" name="excelFile" required="required" onchange="upfile()"></label>
    ...
    <script>
        ...
        $(function () {
            ...
            document.body.addEventListener("keydown", preBackKey)
            document.body.addEventListener("keypress", preBackKey)
        });
        function preBackKey(e) {
