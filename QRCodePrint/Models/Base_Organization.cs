namespace QRCodePrint.Models
{
    ...
    public partial class Base_Organization
    {
        ...
        public bool IsLegacyOrg { get; set; }

        public bool IsOperatingOrg { get; set; }

        public bool IsInventoryOrg { get; set; }

        public bool IsPlantOrg { get; set; }

        public bool IsAssetOrg { get; set; }

        public bool IsAuditOrg { get; set; }

        public bool IsServiceOrg { get; set; }

        public long Location { get; set; }

        public long? RegisterAddress { get; set; }

        public long? BOMRefOrg { get; set; }
        ...
        public bool IsPortalOrg { get; set; }

        public long? DefaultLanguage { get; set; }

        public bool IsSettlementOrg { get; set; }

        public bool IsBudgetOrg { get; set; }
